...
public class Buffalo extends PrimaryConsumer{
	...
	public String toString() {
		return "Buffalo [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
	...
	public Buffalo(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
