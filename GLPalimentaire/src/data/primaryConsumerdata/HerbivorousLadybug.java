...
public class HerbivorousLadybug extends PrimaryConsumer{
	...
	public String toString() {
		return "HerbivorousLadybug [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
	...
	public HerbivorousLadybug(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
