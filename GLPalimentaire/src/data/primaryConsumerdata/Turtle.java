...
public class Turtle extends PrimaryConsumer{
	...
	public String toString() {
		return "Turtle [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
	...
	public Turtle(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
