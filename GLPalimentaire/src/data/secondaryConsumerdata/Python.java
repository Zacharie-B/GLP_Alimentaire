...
public class Python extends SecondaryConsumer{
	...
	public Python(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
	...
	public String toString() {
		return "Python [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
