...
public class Jaguar extends TertiaryConsumer {
	...
	public Jaguar(String name, int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
	...
	public String toString() {
		return "Jaguar [getName()=" + getName() + ", getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy()
