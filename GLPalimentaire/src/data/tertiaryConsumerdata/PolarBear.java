...
public class PolarBear extends TertiaryConsumer{
	...
	public PolarBear(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
	...
	public String toString() {
		return "PolarBear [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
