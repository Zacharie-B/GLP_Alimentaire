...
public class Sheatfish extends TertiaryConsumer{
	...
	public Sheatfish(String name, int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
	...
	public String toString() {
		return "Sheatfish [getName()=" + getName() + ", getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy()
