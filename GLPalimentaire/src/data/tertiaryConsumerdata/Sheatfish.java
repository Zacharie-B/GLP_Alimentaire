...
public class Sheatfish extends TertiaryConsumer{
	...
	public Sheatfish(int hp, int organicMass, boolean isAlive, int populationDensity, int numberBirths, 
	...
	public String toString() {
		return "Sheatfish [getHp()=" + getHp() + ", getEatenBy()=" + getEatenBy() + ", getDiet()=" + getDiet()
