...
public class LoggerUtility {
	private static final String TEXT_LOG_CONFIG = "src/tests/log4j-text.properties";
	private static final String HTML_LOG_CONFIG = "src/tests/log4j-html.properties";
